...
# from src.user_idea.serializers import AvatarIdeaSerializer
...
class IdeaProfileSerializer(serializers.ModelSerializer):
    ...
    def get_avatar(self, obj):
        from ..user_idea.serializers import AvatarIdeaSerializer
        serializer = AvatarIdeaSerializer(obj.avatar)
